...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he34514fc3f2456f3: (a: number, b: number) => void;
  readonly closure116_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure151_externref_shim: (a: number, b: number, c: any, d: any) => void;
